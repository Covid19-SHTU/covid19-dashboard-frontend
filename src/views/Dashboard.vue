    ...
    <v-row v-else key="view">
      ...
      <v-col cols="12" md="8">
        ...
        <v-card class="mt-4">
          ...
          <v-data-table :headers="table_headers" :items="tableItems()" :search="search" sort-by="cumulative_cases" sort-desc items-per-page="5" :footer-props="{itemsPerPageOptions: [5, 10, 15]}"></v-data-table>
        </v-card>
      </v-col>
    </v-row>
    </transition>
